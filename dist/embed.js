/*! Simple Analytics Embed script development version */
'use strict';/*!
 * Chart.js v3.6.0
...
TimeSeriesScale.defaults = TimeScale.defaults;function toInteger(dirtyNumber) {
...
var formatDistance$1 = formatDistance;function buildFormatLongFn(args) {
  return function () {
...
var formatLong$1 = formatLong;var formatRelativeLocale = {
...
var formatRelative$1 = formatRelative;function buildLocalizeFn(args) {
...
var localize$1 = localize;function buildMatchFn(args) {
...
var formatters$3 = formatters$2;var MILLISECONDS_IN_DAY = 86400000; // This function will be a part of public API when UTC function will be implemented.
...
var formatters$1 = formatters;function dateLongFormatter(pattern, formatLong) {
  switch (pattern) {
    case 'P':
...
var parsers$1 = parsers;var TIMEZONE_UNIT_PRIORITY = 10; // This RegExp consists of three parts separated by `|`:
// - [yYQqMLwIdDecihHKkms]o matches any available ordinal number token
//   (one of the certain letters followed by `o`)
// - (\w)\1* matches any sequences of the same letter
// - '' matches two quote characters in a row
...
});var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};var lodash_clonedeep = {exports: {}};/**
...
var cloneDeep = lodash_clonedeep.exports;const log = (message, severity = "info") => {
  if (console?.[severity]) console[severity](prefix, message);
};

const prefix = "[Simple Analytics Embed]";const thousandsSeparator = (number) => {
...
const k = (number, roundNumbers = true) => {
...
const convertPercentToHex = (percentString) => {
...
const convertPercentToDecimal = (percentString) => {
  const percent = parseInt("" + percentString, 10);
...
const createSVGLogo = ({ fill }) => {
  ...
  return svg;
};const docs = "https://docs.simpleanalytics.com/embed-chart-on-your-site";
